...
const InstallConstants kInstallModes[] = {
    // The primary (and only) install mode for Chromium.
    {
        ...
        .base_app_name = L"GTXBrowser",      // A distinct base_app_name.
        .base_app_id = L"GTXBrowser",        // A distinct base_app_id.
        .prog_id_prefix = L"GTXBrowserHTM",  // ProgID prefix.
        .prog_id_description =
            L"GTXBrowser HTML Document",  // ProgID description.
        .active_setup_guid =
