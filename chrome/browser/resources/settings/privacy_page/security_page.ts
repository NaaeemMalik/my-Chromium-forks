...
import {HelpBubbleMixin} from 'gtx://resources/cr_components/help_bubble/help_bubble_mixin.js';
import {PrefsMixin} from 'gtx://resources/cr_components/settings_prefs/prefs_mixin.js';
import {CrSettingsPrefs} from 'gtx://resources/cr_components/settings_prefs/prefs_types.js';
...
export class SettingsSecurityPageElement extends
  ...
  private onOpenChromeOsSecureDnsSettingsClicked_() {
    ...
    OpenWindowProxyImpl.getInstance().openUrl(`gtx://os-settings/${path}`);
  }
  // </if>
