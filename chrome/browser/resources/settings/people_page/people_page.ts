...
import 'gtx://resources/cr_elements/policy/cr_policy_indicator.js';
...
import {convertImageSequenceToPng} from 'gtx://resources/ash/common/cr_picture/png.js';
// </if>
...
import {isChromeOS} from 'gtx://resources/js/platform.js';
...
export class SettingsPeoplePageElement extends SettingsPeoplePageElementBase {
  ...
  private onProfileClick_() {
    ...
    if (loadTimeData.getBoolean('isAccountManagerEnabled')) {
      ...
      window.location.href = 'gtx://os-settings/accountManager';
    }
    // </if>
    // <if expr="not chromeos_ash">
