...
import {sanitizeInnerHtml} from 'gtx://resources/js/parse_html_subset.js';
import {htmlEscape} from 'gtx://resources/js/util_ts.js';
import {beforeNextRender, PolymerElement} from 'gtx://resources/polymer/v3_0/polymer/polymer_bundled.min.js';
...
export class DownloadsItemElement extends DownloadsItemElementBase {
  ...
  private computeControlledBy_(): string {
    ...
    const url = `gtx://extensions/?id=${this.data.byExtId}`;
