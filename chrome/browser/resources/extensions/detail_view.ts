...
import 'gtx://resources/cr_elements/cr_toggle/cr_toggle.js';
import 'gtx://resources/cr_elements/icons.html.js';
import 'gtx://resources/cr_elements/policy/cr_tooltip_icon.js';
...
import 'gtx://resources/cr_elements/action_link.css.js';
...
import {CrLinkRowElement} from 'gtx://resources/cr_elements/cr_link_row/cr_link_row.js';
import {CrToggleElement} from 'gtx://resources/cr_elements/cr_toggle/cr_toggle.js';
import {CrTooltipIconElement} from 'gtx://resources/cr_elements/policy/cr_tooltip_icon.js';
import {assert} from 'gtx://resources/js/assert_ts.js';
import {focusWithoutInk} from 'gtx://resources/js/focus_without_ink.js';
...
export class ExtensionsDetailViewElement extends
  ...
  private onSiteSettingsClick_() {
    this.delegate.openUrl(
        `gtx://settings/content/siteDetails?site=chrome-extension://${
            this.data.id}`);
  }
