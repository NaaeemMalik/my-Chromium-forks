...
* Catapult telemetry tests, located in GTX Browser under `third_party/catapult`,
  mostly `third_party/catapult/telemetry/telemetry/internal/backends/chrome/oobe.py`.
* Autotests, located in GTX BrowserOS under `src/third_party/autotests`, mostly
...
* Tast tests, located in GTX BrowserOS under `src/platform/tast-tests/`, mostly
