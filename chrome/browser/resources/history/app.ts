...
import 'gtx://resources/cr_components/history_clusters/clusters.js';
...
import 'gtx://resources/polymer/v3_0/iron-media-query/iron-media-query.js';
...
import {WebUiListenerMixin, WebUiListenerMixinInterface} from 'gtx://resources/cr_elements/web_ui_listener_mixin.js';
...
import {getTrustedScriptURL} from 'gtx://resources/js/static_types.js';
import {hasKeyModifiers} from 'gtx://resources/js/util_ts.js';
import {IronA11yAnnouncer} from 'gtx://resources/polymer/v3_0/iron-a11y-announcer/iron-a11y-announcer.js';
import {IronPagesElement} from 'gtx://resources/polymer/v3_0/iron-pages/iron-pages.js';
  ...
  static get properties() {
    return {
      ...
      tabsIcons_: {
        type: Array,
        value: () =>
            ['images/list.svg', 'gtx://resources/images/icon_journeys.svg'],
      },
