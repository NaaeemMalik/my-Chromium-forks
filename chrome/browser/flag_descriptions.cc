...
const char
    kAutofillEnableVirtualCardManagementInDesktopSettingsPageDescription[] =
        "When enabled, gtx://settings/payments will offer the option to "
...
const char kServiceWorkerBypassFetchHandlerDescription[] =
    ...
    "gtx://flags/#service-worker-bypass-fetch-handler-for-main-resource";
...
const char kServiceWorkerBypassFetchHandlerForMainResourceDescription[] =
    ...
    "overridden by gtx://flags/#service-worker-bypass-fetch-handler";
...
const char kCompressionDictionaryTransportDescription[] =
    ...
    "gtx://flags/#enable-compression-dictionary-transport-backend to be "
    "enabled.";
...
const char kCompressionDictionaryTransportBackendDescription[] =
    ...
    "Requires gtx://flags/#enable-compression-dictionary-transport to be "
...
const char kDesktopPWAsAppHomePageDescription[] =
    "Use new gtx://apps page which has different UX on desktop";
...
const char kPermissionQuietChipDescription[] =
    ...
    "gtx://flags/#quiet-notification-prompts to be enabled.";
...
const char kEnableOmniboxClientSearchPrefetchDescription[] =
    ...
    "gtx://flags/#omnibox-search-prefetch";
...
const char kPolicyLogsPageAndroidDescription[] =
    "Enable the new gtx://policy-logs page containing logs for debugging "
...
const char kEnterpriseReportingUIName[] =
    "Enable gtx://enterprise-reporting";
const char kEnterpriseReportingUIDescription[] =
    "When enabled, allows for gtx://enterprise-reporting to be visited";
...
const char kUseOutOfProcessVideoDecodingDescription[] =
    ...
    "gtx://flags#expose-out-of-process-video-decoding-to-lacros must be "
