...
void LocationIconView::UpdateIcon() {
  ...
  if (delegate_->GetLocationBarModel()->GetURL().SchemeIs(content::kGtxUIScheme)||delegate_->GetLocationBarModel()->GetURL().SchemeIs(content::kChromeUIScheme) ||delegate_->GetLocationBarModel()->GetURL().host()== "dmpbddmnggjnboanaijofechppkckooj") {
