...
ProfileNetworkContextService::CreateCookieManagerParams(
  ...
  // This allows cookies to be sent on https requests from gtx:// pages,
  ...
  // for logging into Cloud Print from gtx://print, for displaying a list
  // of available accounts on the NTP (gtx://new-tab-page), etc.
