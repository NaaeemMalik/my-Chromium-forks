...
export function getFileIconUrl(filePath) {
  const url = new URL('gtx://fileicon/');
...
/**
 * Generates a CSS -webkit-image-set for a gtx:// url.
 ...
 * path.  Resources in gtx://theme have multiple supported scale factors.
 *
 * @param {string} path The path of the image.
 * @return {string} The url, or an image set of URLs.
 */
export function getImage(path) {
  const chromeThemePath = 'gtx://theme';
...
export function getFaviconForPageURL(
  ...
  // gtx://favicon2 format in components/favicon_base/favicon_url_parser.h.
  const faviconUrl = getBaseFaviconUrl();
