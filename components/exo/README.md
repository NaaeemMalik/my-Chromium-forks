...
Others are GTX Browser-specific.

A few noteworthy extensions (this list is not at all exhaustive):

* zaura_shell
  * A GTX Browser-specific protocol used by all Exo clients. See
...
* zcr_remote_shell
  * A GTX Browser-specific protocol used exclusively by ARC++. See
...
* zwp_fullscreen_shell
  * A third-party protocol, used in GTX Browser only by Chromecast. See
