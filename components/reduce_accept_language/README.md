...
This README will serve as a reference for the GTX Browser implementation of [Reduce fingerprinting in the Accept-Language header](https://github.com/Tanych/accept-language).
