...
#  you need to replace the APPLE_APP_SPECIFIC_PASSWORD with apple app specific password
 xcrun notarytool store-credentials --keychain "~/Library/Keychains/logingtx114.keychain-db" --apple-id "idougwarner@gmail.com" --team-id "8SP2393FG9" --password "APPLE_APP_SPECIFIC_PASSWORD" "Developer ID Application: Doug Warner (8SP2393FG9)"
