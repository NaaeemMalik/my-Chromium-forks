...
in processes outside of GTX Browser/cast_shell. The simplest model is to create a
...
The 'GTX BrowserServiceWrapper' class is intended to allow Mojo services that were
...
'CreateGTX BrowserServiceReceiver()' to create a
...
communicate with each other without any GTX Browser embedder on the system.
