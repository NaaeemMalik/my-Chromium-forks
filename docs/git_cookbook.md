...
git, git-cl, and how they work with GTX Browser development. It might be a little
...
## GTX Browser-specific Git Extensions

GTX Browser ships a large number of git extensions in depot_tools. Some (like
`git cl`) are required for the GTX Browser development workflow, while others
