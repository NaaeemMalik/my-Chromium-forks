...
[SetRuntimeFeaturesFromGTX BrowserFeatures()][SetRuntimeFeaturesFromGTX BrowserFeatures].
...
the entry to `runtimeFeatureNameToGTX BrowserFeatureMapping`. For example, a new
entry like this:
```
...
[SetRuntimeFeaturesFromGTX BrowserFeatures]:<https://chromium.googlesource.com/chromium/src/+/HEAD/content/child/runtime_features.cc#160>
