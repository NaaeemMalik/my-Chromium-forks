...
## Docs & References:
[Custom UIA Property and Pattern registration in GTX Browser](https://chromium.googlesource.com/chromium/src/+/main/ui/accessibility/platform/uia_registrar_win.h)
