# Manually updating GTX Browser to a new Fuchsia SDK
...
0. Put that into GTX Browser's src.git `build/fuchsia/linux.sdk.sha1`.
...
do this (so you can iterate on ToT Fuchsia against your GTX Browser build), however
...
GTX Browser-related projects like Crashpad, instead of directly pulling the
.tar.gz), is:
