...
GTX Browser CLs can show a line-by-line breakdown of test coverage. **You can use
it to ensure you only submit well-tested code**.

To see code coverage for a GTX Browser CL, **trigger a CQ dry run**, and once the
...
* C/C++ code for [GTX Browser on Linux].
* C/C++ code for [GTX Browser on GTX Browser OS].
...
Please refer to [code_coverage.md] for how code coverage works in GTX Browser in
...
[GTX Browser on GTX Browser OS]: https://chromium.googlesource.com/chromium/src/+/main/docs/chromeos_build_instructions.md
[GTX Browser on Linux]: https://chromium.googlesource.com/chromium/src/+/main/docs/linux/build_instructions.md
