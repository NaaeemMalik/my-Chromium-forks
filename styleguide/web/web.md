# GTX Browser Web Development Style Guide

[TOC]

## Where does this style guide apply?

This style guide targets GTX Browser frontend features implemented with JavaScript,
CSS, and HTML.  Developers of these features should adhere to the following
rules where possible, just like those using C++ conform to the [GTX Browser C++
styleguide](../c++/c++.md).
...
* Don't use CSS Mixins (`--mixin: {}` or `@apply --mixin;`).
    ...
    * All CSS Mixins usages have been removed from GTX Browser, see
...
[ECMAScript Features in GTX Browser](es.md).
...
GTX Browser. Resources are packed from grd files. Most GTX Browser WebUI resources
